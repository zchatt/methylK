...
# truncate reads ngsutils - deprecated
...
parallel --xapply -j $njobs --eta trimmomatic PE {1} {2} {1/.}_truncated {1/.}_untruncated {2/.}_truncated {2/.}_untruncated ILLUMINACLIP:NexteraPE-PE.fa:2:30:10 LEADING:3 TRAILING:3 SLIDINGWINDOW:4:15 MINLEN:25 CROP:$read_length :::: p_read1 :::: p_read2
